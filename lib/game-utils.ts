import type { DeezerTrack, TrackOption, TrackQuestion, GameState } from './types'
import { WIN_SCORE, MAX_LIVES } from './types'
import { shuffleArray } from './deezer'

/**
 * Trasforma una DeezerTrack in un TrackOption da mostrare all'utente.
 */
export function trackToOption(track: DeezerTrack, isCorrect: boolean): TrackOption {
  return {
    id: track.id,
...
export function buildQuestion(
  ...
  return {
    ...
    albumCover: correct.album.cover_medium,
    options,
  }
}
