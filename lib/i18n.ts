...
export const TRANSLATIONS = {
  it: {
    ...
    'gameover.modal.title': '🏆 Sei nella top 30!',
  ...
  en: {
    ...
    'gameover.modal.title': '🏆 You\'re in the top 30!',
  ...
  es: {
    ...
    'gameover.modal.title': '🏆 ¡Estás en el top 30!',
  ...
  fr: {
    ...
    'gameover.modal.title': '🏆 Tu es dans le top 30 !',
  ...
  de: {
    ...
    'gameover.modal.title': '🏆 Du bist in den Top 30!',
